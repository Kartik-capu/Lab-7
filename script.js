...
const firebaseProjectUrl = 'https://comp101-lab8-kartik-default-rtdb.firebaseio.com/';
...
async function submitForm() {
    ...
    if (name || email || message) {  // <-- updated so email counts too
        const data = { name, email, message };  // <-- email added to data object
